...
namespace TaskManager.Business.Services.Interfaces
{
    public interface INotificationService
    {
        ...
        Task<NotificationReadDto> CreateAsync(NotificationCreateDto dto, string currentUserId, NotificationType type = NotificationType.TaskAssigned, long? referenceId = null);
